...
<body>
	...
	<div class="container-fluid">
		<form action="/board/list" class="d-flex" method="get">
			...
			<nav aria-label="Page navigation example">
				<ul class="pagination">
					...
					<c:forEach begin="${ph.startPage }" end="${ph.endPage}" var="i">
						<li class="page-item">
						<a class="page-link" href="/board/list?pageNo=${i}&qty=${ph.pgvo.qty}&type=${ph.pgvo.type}&keyword=${ph.pgvo.keyword}">${i}</a></li>
					</c:forEach>
